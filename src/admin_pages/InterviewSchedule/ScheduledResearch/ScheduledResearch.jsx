...
function ScheduledResearch() {
  ...
  const ScheduledResearchData = ScheduledResearchTable.slice(
    startIndex,
    endIndex
  );
  return (
      ...
      <div className="SCARS-table">
        ...
        <div className="table-responsive">
          <table className="table">
            ...
            <tbody>
              {ScheduledResearchData.map((data, index) => (
                <tr key={index}>
                  <td>
                    <b> {data["S.No"]} </b>
                  </td>
          ...
          <div className="pagination">
            <Stack spacing={2}>
              <Pagination
                count={Math.ceil(ScheduledResearchTable.length / rowsPerPage)}
                page={page}
