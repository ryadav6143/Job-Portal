...
function ScheduledTechnical() {
  ...
  const ScheduledTechnicalData = ScheduledTechnicalTable.slice(
    startIndex,
    endIndex
  );
  return (
      ...
      <div className="SCTEC-table">
        ...
        <div className="table-responsive">
          <table className="table is-table">
            ...
            <tbody>
              {ScheduledTechnicalData.map((data, index) => (
                <tr key={index}>
                  <td>
                    <b> {data["S.No"]} </b>
                  </td>
          ...
          <div className="pagination">
            <Stack spacing={2}>
              <Pagination
                count={Math.ceil(ScheduledTechnicalTable.length / rowsPerPage)}
                page={page}
