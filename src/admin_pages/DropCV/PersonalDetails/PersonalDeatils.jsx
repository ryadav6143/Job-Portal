            ...
            <div className="col-md-6">
              ...
              <div className="form-section">
                ...
                <input
                  ...
                  value=""
                  required
                ></input><FontAwesomeIcon className="set-icon"  icon={faEnvelope} />
              </div>
            </div>
            ...
            <div className="col-md-6">
              ...
              <div className="form-section">
                ...
                <input
                  ...
                  value=""
                  required
                ></input><FontAwesomeIcon className="set-icon" icon={faMobile} />
              </div>
            </div>
          </div>
            ...
            <div className="col-md-6">
              ...
              <div className="form-section">
                ...
                {/* <select name="city" className="set-dropdown">
                 ...
                 <select name="city" className="set-dropdown" onChange={handleCityChange}>
          <option value="">Select city</option>
          {cities.map((city) => (
...
<select name="country" className="set-dropdown" onChange={handleCountryChange}>
          <option value="">Select country</option>
          {countries.map((country) => (
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              ...
              <div className="form-section">
                ...
                <select name="applied_post_masters_id" className="set-dropdown">
 ...
 <div className="form-section">
                ...
                <select name="applied_subpost_masters_id" className="set-dropdown">
